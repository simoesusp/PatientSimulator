...
int main()
{
    ...
    servidor.sin_addr.s_addr = inet_addr("192.168.0.32");
    ...
    while(1) {
        ...
        if (strcmp(mensagemServidor, "tocar1") == 0) {
        	system("play /home/pi/Raspberry/Atritopleural.mp3 &");	
        }
        if (strcmp(mensagemServidor, "tocar2") == 0) {
        	system("play /home/pi/Raspberry/Estertorfino.mp3 &");	
        }
        if (strcmp(mensagemServidor, "tocar3") == 0) {
        	system("play /home/pi/Raspberry/Estertorgrosso.mp3 &");	
        }
        if (strcmp(mensagemServidor, "tocar4") == 0) {
        	system("play /home/pi/Raspberry/Murmurio_vesicular.mp3");	
        }
        if (strcmp(mensagemServidor, "tocar5") == 0) {
        	system("play /home/pi/Raspberry/Estridor.mp3 &");	
        }
        else {
            ...
            printf("\nA mensagem da Raspbrry foi: %s\n", mensagem);
    	}

        printf("\nA mensagem do servidor foi: %s\n", mensagemServidor);    
        //Atribui zero para todos os bytes do vetor
        memset(mensagemServidor,'\0',sizeof(mensagemServidor));

...
int main()
{
    ...
    while(1) {
        ...
        else if (strcmp(mensagemServidor, "som2") == 0) {
        	system("pkill play");
        	system("play /home/pi/Raspberry/Estridor.mp3 &");	
        }
        else if (strcmp(mensagemServidor, "som1rapido") == 0) {
        	system("pkill play");
        	system("play /home/pi/Raspberry/Atritopleural.mp3 speed 1.5 &");	
        }
        else if (strcmp(mensagemServidor, "som2rapido") == 0) {
        	system("pkill play");
        	system("play /home/pi/Raspberry/Estridor.mp3 speed 1.5 &");	
        }
